...
// This class has been constructed using the Firestore quickstart-android project as reference
abstract class FirestoreAdapter<VH : RecyclerView.ViewHolder>(private var query: Query?):
    ...
    override fun onEvent(documentSnapshots: QuerySnapshot?, error: FirebaseFirestoreException?) {
        ...
        // If the snapshots received are null
